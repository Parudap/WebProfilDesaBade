        ...
        <div class="container-shell">
            ...
            <div class="grid gap-8 lg:grid-cols-3">
                ...
                <div class="lg:col-span-2 content-card p-6 md:p-10">
                    ...
                    <!-- Sharing -->
                    <div class="mt-10 pt-6 border-t border-gray-100 flex items-center gap-3 flex-wrap">
                        <span class="text-sm font-bold text-gray-800">Bagikan:</span>
                        <!-- Facebook -->
                        <a href="#" class="h-9 w-9 rounded-full bg-[#1877f2] hover:bg-opacity-90 text-white flex items-center justify-center transition shadow-sm">
                        ...
                        <!-- Whatsapp -->
                        <a href="#" class="h-9 w-9 rounded-full bg-[#25d366] hover:bg-opacity-90 text-white flex items-center justify-center transition shadow-sm">
                            <svg class="h-4 w-4 fill-current flex-shrink-0" width="16" height="16" viewBox="0 0 24 24">
                        ...
                        <!-- Twitter/X -->
                        <a href="#" class="h-9 w-9 rounded-full bg-black hover:bg-opacity-90 text-white flex items-center justify-center transition shadow-sm">
                            <svg class="h-4 w-4 fill-current flex-shrink-0" width="16" height="16" viewBox="0 0 24 24">
                                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                            </svg>
                        </a>
                        <!-- LinkedIn -->
                        <a href="#" class="h-9 w-9 rounded-full bg-[#0a66c2] hover:bg-opacity-90 text-white flex items-center justify-center transition shadow-sm">
                            <svg class="h-4 w-4 fill-current flex-shrink-0" width="16" height="16" viewBox="0 0 24 24">
