...
<title>IDM - Admin Desa Bade</title>
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-group">
            ...
            <div id="infografis" class="nav-submenu open">
                ...
                <a href="{{ route('admin.infografis.idm') }}" class="nav-subitem active-sub">IDM</a>
...
<div class="main">
    <header class="topbar">
        <div class="topbar-left"><h2>IDM</h2><p>Kelola dokumen Indeks Desa Membangun</p></div>
        <div class="breadcrumb"><a href="{{ route('admin.dashboard') }}">Dashboard</a><span>&rsaquo;</span><span>Infografis</span><span>&rsaquo;</span><span style="color:#2e7d32;font-weight:600">IDM</span></div>
    </header>
        ...
        <div class="page-grid">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="font-weight:600;max-width:200px">{{ $item->judul ?: 'IDM '.$item->tahun }}</td>
                                    ...
                                    <td style="white-space:nowrap">
                                        ...
                                        @endif
                                        <button class="btn-del" onclick="openDeleteModal({{ $item->id }},'{{ addslashes($item->judul ?: 'IDM '.$item->tahun) }}')">Hapus</button>
                                    </td>
                                </tr>
                                @empty
                                <tr class="empty-row"><td colspan="6">Belum ada dokumen IDM. Upload di panel kanan.</td></tr>
                                @endforelse
                            </tbody>
                        </table>
                    </div>
            ...
            <div>
                <div class="card" style="margin-bottom:0">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.infografis.idm.store') }}" enctype="multipart/form-data">@csrf
                            <div class="form-group">
                                <label class="form-label">Judul Dokumen <span class="req">*</span></label>
                                <input type="text" name="judul" class="form-input" placeholder="cth: Data IDM 2025" required maxlength="200">
                            </div>
                            <div class="form-group">
...
<div class="modal-backdrop" id="modal-delete">
    <div class="modal">
        <div class="modal-body" style="padding-top:28px">
            ...
            <div class="confirm-text"><h3>Hapus Dokumen IDM?</h3><p>Dokumen <strong id="delete-name"></strong> akan dihapus permanen.</p></div>
        </div>
...
function openDeleteModal(id,name){document.getElementById('form-delete').action=`/admin/infografis/idm/${id}`;document.getElementById('delete-name').textContent=name;openModal('modal-delete')}
